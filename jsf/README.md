...
18. [A h:outputText example](outputText/README.md)
19. [A f:param example](param/README.md)
20. [An injected RequestCookieMap example](requestCookieMap/README.md)
21. [A RequestScoped bean example](requestScoped/README.md)
22. [An injected SessionMap example](sessionMap/README.md)
23. [A SessionScoped bean example](sessionScoped/README.md)
24. [An injected ViewMap example](viewMap/README.md)
25. [A ViewScoped bean example](viewScoped/README.md)
