...
/**
 * The JUnit tests for the inject ApplicationMap example.
 *
...
public class ApplicationMapTest {
    ...
    public static WebArchive createDeployment() {
        return create(WebArchive.class).
                addClasses(ApplicationMapBean.class).
    ...
    /**
     * Test the injected ApplicationMap.
     * 
     * @throws Exception when a serious error occurs.
     */
    @RunAsClient
    @Test
    public void testInjectedApplicationMap() throws Exception {
